...
movie_info_df.to_csv("csv/test_movie_info_d14.csv",encoding="utf-8")


movieCd = movie_info_df["movieCd"][:1]
...
boxoffice_df.to_csv("csv/test_boxoffice_d14.csv",encoding="utf-8")