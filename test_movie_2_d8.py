...
box_df=pd.read_csv("csv/boxoffice_d8.csv", index_col=0)

box_df['preview_audience']=(4060, 12362)

box_df.to_csv("csv/test_total_movie_d8.csv", encoding="utf-8")

"""frames = [box_df, add_df]
naver_df= pd.concat(frames)"""

naver_df=box_df

naver_df.to_csv("csv/conca_haebom.csv",encoding="utf-8")

#naver_df = pd.read_csv("test_total_movie_d8.csv", index_col=0)
...
url_df.to_csv("csv/test_url_d8.csv",encoding="utf-8")
...
star_score_df.to_csv("csv/test_star_score_d8.csv",encoding="utf-8")